//
//  CMVAlertForVPCiPad.m
//  Casinò di Venezia
//
//  Created by Massimo Moro on 26/05/14.
//  Copyright (c) 2014 Casinò di Venezia SPA. All rights reserved.
//

#import "CMVAlertForVPCiPad.h"

@implementation CMVAlertForVPCiPad
...
- (void)drawRect:(CGRect)rect
{
    ...
    //// Image Declarations
    UIImage* iPhoneVPC = [UIImage imageNamed: @"iPadVPC"];
    ...
    {
        //// Rectangle Drawing
        CGRect rectangleRect = CGRectMake(CGRectGetMinX(group) + floor(CGRectGetWidth(group) * 0.00203 + 0.5), CGRectGetMinY(group) + floor(CGRectGetHeight(group) * 0.00000 + 0.5), floor(CGRectGetWidth(group) * 0.99797 + 0.5) - floor(CGRectGetWidth(group) * 0.00203 + 0.5), floor(CGRectGetHeight(group) * 0.34950 + 0.5) - floor(CGRectGetHeight(group) * 0.00000 + 0.5));
        ...
        //// Rectangle 2 Drawing
        UIBezierPath* rectangle2Path = [UIBezierPath bezierPathWithRect: CGRectMake(CGRectGetMinX(group) + floor(CGRectGetWidth(group) * 0.00203 + 0.5), CGRectGetMinY(group) + floor(CGRectGetHeight(group) * 0.57418) + 0.5, floor(CGRectGetWidth(group) * 0.99898) - floor(CGRectGetWidth(group) * 0.00203 + 0.5) + 0.5, floor(CGRectGetHeight(group) * 0.80813) - floor(CGRectGetHeight(group) * 0.57418))];
        [color2 setFill];
        [rectangle2Path fill];
        [color4 setStroke];
        ...
        //// Rectangle 4 Drawing
        UIBezierPath* rectangle4Path = [UIBezierPath bezierPathWithRect: CGRectMake(CGRectGetMinX(group) + floor(CGRectGetWidth(group) * 0.00203 + 0.5), CGRectGetMinY(group) + floor(CGRectGetHeight(group) * 0.80456 + 0.5), floor(CGRectGetWidth(group) * 0.99797 + 0.5) - floor(CGRectGetWidth(group) * 0.00203 + 0.5), floor(CGRectGetHeight(group) * 0.81027 + 0.5) - floor(CGRectGetHeight(group) * 0.80456 + 0.5))];
        [color3 setFill];
        [rectangle4Path fill];
