...
#import "CMVSplitTournaments.h"
#import "CMVAllGamesViewController.h"


@interface CMVSplitTournaments ()
...
@implementation CMVSplitTournaments
...
- (void)viewDidLoad
{
    ...
    CMVAllGamesViewController *secondVC = [storyboard instantiateViewControllerWithIdentifier:@"AllTournaments"];
       ...
       forPopoverController:(UIPopoverController *)pc
{
    ...
    // will do nothing.
    barButtonItem.title = NSLocalizedString(@"TOURNAMENTS",nil);
