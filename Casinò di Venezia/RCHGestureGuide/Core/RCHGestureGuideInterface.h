...
extern NSString *const RCHGestureDoubleTap;
extern NSString *const RCHGestureSwipeLeft;
extern NSString *const RCHGestureSwipeRight;
extern NSString *const RCHGestureSwipeRightUp;
extern NSString *const RCHGestureTapUp;
