...
@interface CMVGameSplitViewController ()
...
@implementation CMVGameSplitViewController
...
- (void)viewDidLoad
{
    ...
    CMVAllGamesViewController *secondVC = [storyboard instantiateViewControllerWithIdentifier:@"AllGames"];
       ...
       forPopoverController:(UIPopoverController *)pc
{
    ...
    // will do nothing.
    barButtonItem.title = NSLocalizedString (@"GAMES",nil);
